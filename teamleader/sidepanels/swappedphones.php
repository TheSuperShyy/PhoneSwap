          ...
          <div class="flex flex-col gap-3 mx-auto py-4 w-full">
            ...
            <div class="flex laptop:flex-row phone:flex-col gap-3 justify-between">
              <div class="flex flex-row gap-5 border-b border-black">
                <a href="swapphones.php" class="font-semibold laptop:text-lg phone:text-sm hover:border-b-2 hover:border-black">Swap Phones</a>
                <a href="swappedphones.php" class="font-semibold laptop:text-lg phone:text-sm border-b-2 border-black">Swapped Phones</a>
              </div>
              <div class="flex flex-row gap-4">
                ...
                <div class="flex laptop:flex-row phone:flex-col gap-2 w-full">
                  ...
                  <div class="flex flex-row ml-auto gap-2">
                    <button class="flex items-center gap-2 border border-white bg-amber-400 hover:bg-amber-600 hover:bg-opacity-95 text-white px-4 py-2 rounded-lg shadow-md">
