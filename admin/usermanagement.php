  ...
  <body>
    <div class="flex">
      ...
      <div class="w-4/5 ml-auto">
        <!-- Navbar section -->
        <div
          class="fixed w-4/5 bg-white z-10 px-6 py-3 flex justify-between items-center shadow-md"
        >
          <!-- Menubar -->
        ...
        <div class="pt-22 py-6 laptop:px-12 phone:px-4">
          <!-- contents -->
          <div
            class="flex flex-col gap-1 items-end justify-center w-full mx-auto"
          >
                ...
                <div class="w-full overflow-x-auto h-full rounded-lg">
                  <table class="w-full bg-white">
                    <thead class="bg-gray-200">
                      <tr
                        class="bg-gray-200 border-b border-gray-400 text-sm text-left px-4"
                      >
                    ...
                    <tbody>
                      <tr class="border-b text-left">
                        ...
                        <td class="py-2 px-4 whitespace-nowrap">Kian David</td>
                        <td class="py-2 px-4 whitespace-nowrap">Team Leader</td>
                        <td class="py-2 px-4 whitespace-nowrap">
                          Kian@gmail.com
                        </td>
                        <td class="py-2 px-4 whitespace-nowrap">Table 1</td>
                      ...
                      <tr class="border-b text-left">
                        <td class="py-2 px-4 whitespace-nowrap">0002</td>
                        <td class="py-2 px-4 whitespace-nowrap">
                          Cylie Gonzales
                        </td>
                        <td class="py-2 px-4 whitespace-nowrap">Team Leader</td>
                        ...
                        <td class="py-2 px-4 whitespace-nowrap">Table 2</td>
                        <td class="text-center space-x-2">
                          <div class="flex flex-row py-2 px-4 gap-1">
                            <button
                              id="openModalBtn1"
                      ...
                      <tr class="border-b text-left">
                        <td class="py-2 px-4 whitespace-nowrap">0003</td>
                        <td class="py-2 px-4 whitespace-nowrap">
                          Yul Grant Gatchalian
                        </td>
                        <td class="py-2 px-4 whitespace-nowrap">Team Leader</td>
                        <td class="py-2 px-4 whitespace-nowrap">
                          YulGrant@gmail.com
                      ...
                      <tr class="border-b text-left">
                        <td class="py-2 px-4 whitespace-nowrap">0004</td>
                        <td class="py-2 px-4 whitespace-nowrap">
                          Miko Basilio
                        </td>
                        <td class="py-2 px-4 whitespace-nowrap">Team Leader</td>
                      ...
                      <tr class="border-b text-left">
                        <td class="py-2 px-4 whitespace-nowrap">0005</td>
                        <td class="py-2 px-4 whitespace-nowrap">
                          Daniel Quinzy Digo
                        </td>
                        <td class="py-2 px-4 whitespace-nowrap">Team Leader</td>
                      ...
                      <tr class="border-b text-left">
                        <td class="py-2 px-4 whitespace-nowrap">0006</td>
                        <td class="py-2 px-4 whitespace-nowrap">
                          Yul Grant Gatchalian
                        </td>
                        <td class="py-2 px-4 whitespace-nowrap">Team Leader</td>
            ...
            >
              <div
                class="bg-white border border-gray-600 rounded-lg px-6 py-6 shadow-lg relative h-fit w-full"
              >
                ...
                <span
                  class="absolute top-3 right-3 text-gray-500 hover:text-gray-700 cursor-pointer text-2xl"
                  id="closeModalBtn"
                  >&times;</span
                >
                <div class="flex flex-col gap-4 mt-4">
                  ...
                  <div class="flex laptop:flex-row phone:flex-col gap-4">
                    <div class="flex flex-col gap-2 w-full">
                      ...
                      <input
                        type="email"
                        placeholder="Yulgrant@gmail.com"
                        class="border border-gray-700 p-2 rounded-lg"
                      />
                    </div>
                    <div class="flex flex-col gap-2 w-full">
